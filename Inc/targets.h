...
#define EEPROM_DEFAULT_VERSION              0x03    // byte 1: eeprom_version
#define EEPROM_DEFAULT_BOOTLOADER_VERSION   0x01    // byte 2: reserved_1

// Firmware version (bytes 3-4)
// Parameters added in 2.19 (bytes 5-16, was firmware_name)
#ifndef EEPROM_DEFAULT_MAX_RAMP
#define EEPROM_DEFAULT_MAX_RAMP             160     // byte 5: max_ramp (0.1% per ms to 25% per ms)
#endif

#ifndef EEPROM_DEFAULT_MINIMUM_DUTY_CYCLE
#define EEPROM_DEFAULT_MINIMUM_DUTY_CYCLE   1       // byte 6: minimum_duty_cycle (0.2% to 51%)
#endif

#ifndef EEPROM_DEFAULT_DISABLE_STICK_CALIBRATION
#define EEPROM_DEFAULT_DISABLE_STICK_CALIBRATION 0x00 // byte 7: disable_stick_calibration
#endif

#ifndef EEPROM_DEFAULT_ABSOLUTE_VOLTAGE_CUTOFF
#define EEPROM_DEFAULT_ABSOLUTE_VOLTAGE_CUTOFF 10   // byte 8: absolute_voltage_cutoff (1-100 in 0.5v increments)
#endif

#ifndef EEPROM_DEFAULT_CURRENT_P
#define EEPROM_DEFAULT_CURRENT_P            100     // byte 9: current_P (0-255)
#endif

#ifndef EEPROM_DEFAULT_CURRENT_I
#define EEPROM_DEFAULT_CURRENT_I            0       // byte 10: current_I (0-255)
#endif

#ifndef EEPROM_DEFAULT_CURRENT_D
#define EEPROM_DEFAULT_CURRENT_D            100     // byte 11: current_D (0-255)
#endif

#ifndef EEPROM_DEFAULT_ACTIVE_BRAKE_POWER
#define EEPROM_DEFAULT_ACTIVE_BRAKE_POWER   0       // byte 12: active_brake_power (1-5% duty cycle)
#endif
...
#define EEPROM_DEFAULT_TIMING_ADVANCE       0x10    // byte 23: advance_level
#endif
